...
class HairProfileCompleteScreen extends ConsumerStatefulWidget {
  const HairProfileCompleteScreen({super.key});

  @override
  ConsumerState<HairProfileCompleteScreen> createState() =>
      _HairProfileCompleteScreenState();
}

class _HairProfileCompleteScreenState
    extends ConsumerState<HairProfileCompleteScreen>
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [const DiqLogo(size: DiqLogoSize.small)],
                ),
              ),
              ...
              Padding(
                ...
                child: Text(
                  'All 10 steps done — your personalised DermIQ experience starts now.',
              ...
              // Hair profile summary card
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24),
                child: _HairProfileSummaryCard(quiz: quiz),
              )
                  .animate()
              ...
              Padding(
                ...
                child: AppButton(
                  ...
                  onPressed: () {
                    // First-launch setup finished — never force setup again.
...
// ─────────────────────────────────────────────────────────────────────────────
// Animated celebration hero — gold badge variant
// ─────────────────────────────────────────────────────────────────────────────
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            'Step 10 of 10  ·  Hair Profile Done',
...
class _HairProfileSummaryCard extends StatelessWidget {
  final QuizState quiz;
  const _HairProfileSummaryCard({required this.quiz});

  static Color _hairTypeColor(String? type) => switch (type) {
    'Straight' => const Color(0xFFEAB308),
    'Wavy'     => const Color(0xFF06B6D4),
    'Curly'    => const Color(0xFFF43F5E),
    'Coily'    => const Color(0xFF8B5CF6),
    _          => AppColors.primary,
  };

  static Color _scalpTypeColor(String? type) => switch (type) {
    'Oily'      => const Color(0xFF3B82F6),
    'Dry'       => const Color(0xFFF59E0B),
    'Balanced'  => const Color(0xFF22C55E),
    'Sensitive' => const Color(0xFFF43F5E),
    'Flaky'     => const Color(0xFF8B5CF6),
    _           => AppColors.primary,
  };

  bool get _isVirginHair =>
      quiz.hairTreatments.isEmpty ||
      (quiz.hairTreatments.length == 1 &&
          quiz.hairTreatments.first == 'None');

  @override
  Widget build(BuildContext context) {
    final hairColor = _hairTypeColor(quiz.hairType);
    final scalpColor = _scalpTypeColor(quiz.scalpType);
      ...
      child: Column(
        ...
        children: [
          ...
          _SummarySection(
            ...
            iconColor: hairColor,
            label: 'Hair Type',
            child: quiz.hairType != null
                ? _SingleChip(label: quiz.hairType!, color: hairColor)
                : const _EmptyChip(),
          ),
          ...
          _SummarySection(
            ...
            iconColor: scalpColor,
            label: 'Scalp',
            child: quiz.scalpType != null
                ? _SingleChip(label: quiz.scalpType!, color: scalpColor)
                : const _EmptyChip(),
          ),
          ...
          _SummarySection(
            ...
            label: 'Concerns',
            child: quiz.hairConcerns.isEmpty
                ? const _EmptyChip()
                : _ChipRow(
                    items: quiz.hairConcerns,
          ...
          _SummarySection(
            ...
            iconColor: _isVirginHair
                ? AppColors.success
                : const Color(0xFFF43F5E),
            label: 'Treatments',
            child: _isVirginHair
                ? _SingleChip(label: 'Virgin Hair', color: AppColors.success)
                : _ChipRow(
                    items: quiz.hairTreatments,
                    color: const Color(0xFFF43F5E),
                  ),
          ),
        ],
